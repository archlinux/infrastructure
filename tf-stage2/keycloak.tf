...
data "external" "vault_buildbtw_review" {
  program = ["${path.module}/../misc/get_key.py", "${path.module}/../host_vars/buildbtw.archlinux.review/vault_buildbtw_review.yml",
...
resource "keycloak_openid_client" "buildbtw_review_openid_client" {
  ...
  valid_redirect_uris = [
    "https://*.buildbtw.archlinux.review/oidc/authorized"
  ]
}
